...
public class XinhuaNewsDao {
	...
	public List<XinhuaNews> findByExampleForPagination(XinhuaNews xinhuaNews,
	...
	public Query contrustString(XinhuaNews xinhuaNews, String queryString,
			String sort, String order) {
		if (xinhuaNews.getId() != null) {
			queryString += " and a.id =:id";
		}
		if (xinhuaNews.getWebName() != null
				&& !xinhuaNews.getWebName().isEmpty()) {
			queryString += " and a.webName like:webName";
		}
		if (xinhuaNews.getNavigation() != null
				&& !xinhuaNews.getNavigation().isEmpty()) {
			queryString += " and a.navigation =:navigation";
		}
		if (xinhuaNews.getClassify() != null
				&& !xinhuaNews.getClassify().isEmpty()) {
		...
		if (xinhuaNews.getWebLevel() != null
				&& !xinhuaNews.getWebLevel().isEmpty()) {
			queryString += " and a.webLevel =:webLevel ";
		}
		if (xinhuaNews.getRanking() != null
				&& !xinhuaNews.getRanking().isEmpty()) {
			queryString += " and a.ranking =:ranking ";
		}
		if (xinhuaNews.getBelonging() != null
				&& xinhuaNews.getBelonging().isEmpty()) {
